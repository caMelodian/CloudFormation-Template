...
data "template_file" "user_data" {
  ...
  vars = {
    ...
    db_address  = module.rds_instance.address
    db_port     = module.rds_instance.port
...
# locals {
#   dns_name = data.terraform_remote_state.lb.outputs.dns_name
# }
...
# output "remote_rds_address" {
#   value = module.rds_instance.address
# }

# output "remote_rds_port" {
